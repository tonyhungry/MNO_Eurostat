...
```{r message=FALSE}
census.de.100m.tile <- readRDS("C:/Users/ramljak/Desktop/marcocensus.tile.final.rds") 
...
germany.raw <- readRDS("C:/Users/ramljak/Desktop/marcogadm36_DEU_1_sf.rds") 
germany = germany.raw %>%  
...
result.sf <- readRDS("C:/Users/ramljak/Desktop/marcoresult.sf.rds") 
...
```{r}
layers <- readRDS("C:/Users/ramljak/Desktop/marcoradio cell layers.rds") 
coverage.areas <- readRDS("C:/Users/ramljak/Desktop/marcocoverage.areas.rds") 
...
```{r testing}
knitr::include_graphics("C:/Users/ramljak/Desktop/marcoantenna animation.gif")
```
