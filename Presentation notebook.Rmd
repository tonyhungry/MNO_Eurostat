...
germany.raw <- readRDS("C:/Users/ramljak/Desktop/marco/working objects/gadm36_DEU_1_sf.rds") 
germany <- germany.raw %>%  
...
# result.sf <- readRDS("C:/Users/ramljak/Desktop/marco/working objects/result.sf.rds") 
...
cluster.plot <- census.de.100m.tile %>%
  ...
  theme(plot.title = element_text(size = 10, face = "bold", hjust = 0.5),
        plot.subtitle = element_text(size = 9, hjust = 0.5))
plot_grid(cluster.plot, tile.prop.plot, labels = "Population Classification",  
...
```{r network layers}
layers <- readRDS("C:/Users/ramljak/Desktop/marco/working objects/radio cell layers.rds") 
...
plot_grid(layers.plot, labels = "Radio network - Example Layer 1 (Rural)",  
...
```{r animation}
knitr::include_graphics("C:/Users/ramljak/Desktop/marco/working objects/antenna animation.gif")
```
...
tiles.cat <- readRDS("C:/Users/ramljak/Desktop/marco/working objects/coverage intensity.rds")
...
```{r c.vector.distribution}
C.vec.df <- readRDS("C:/Users/ramljak/Desktop/marco/working objects/C.vec.df.final.rds")
# ECCDF of population distribution 
...
```{r estimations 1}
sample.eval <- list.files("C:/Users/ramljak/Desktop/marco/sample evaluation/", 
...
est.plot.list <- list.files("C:/Users/ramljak/Desktop/marco/estimation plots/", 
                            pattern = "*.rds", full.names = TRUE) %>% 
  map(readRDS) %>% 
