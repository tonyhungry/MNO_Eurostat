...
The stacked bar plot shows the proportions of the tiles according to the four categories. Based on our clustering algorithm, `r tile.prop.plot$data$prop[1]`% of the tiles are urban areas. `r tile.prop.plot$data$prop[2]`% of the tiles are uninhabited areas. `r tile.prop.plot$data$prop[3]`% of the tiles are suburban areas, and `r tile.prop.plot$data$prop[4]`% of the tiles are rural areas.
