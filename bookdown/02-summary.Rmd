...
# Plot read in
VT.plot <- readRDS("working objects/VT.plot.rds") + theme(axis.text.x=element_text(angle=90, hjust=1))
VA.plot <- readRDS("working objects/VA.plot.rds") + theme(axis.text.x=element_text(angle=90, hjust=1))
